/** \file phonebook-c-project
*   \anchor Ebraj Gurung
*	\brief This is a simple project built in C where you can save the Infos of a person and can modify and delete it too.
*	
*	Angelina Engelmann only made a Dokumetation its not her project
*	\bug no bugs only features
*
*/
...
/**	\brief  Defines the coordinates of a character cell in a console screen buffer and opensconsole screen 
 * 	\var 'x' horizontal coordinate or the column value
...
/**	\brief  imports the core data of a contact and stores it in an external txt file
 * 	
 */
...
/**	\brief   searches for the name in your contact list and outputs the found data
 * 	\param name1 SEARCH TERM / name
 * 
 *  returns name, address, gender, gmail, phonenumber
 * 
 */
...
/**	\brief    outputs the all contacts
 * 	
 */
...
/**	\brief asks for the password (ebrajdon) and allows or denies access 
 * 	
 *  
 * 
 */
...
/** \brief Containes all 6 options type : 1-6 to choose an application
*	
*
*/
